...
const Main = () => {
    return (_jsx(ContainerMain, { children: _jsxs(CardsDiv, { children: [_jsx(Card, { txt: 'Cadastrar novo Livro', rota: '/home/cadastro', alt: 'cadastro', imagem: ImgCadastro }), _jsx(Card, { txt: 'Biblioteca', rota: '/home/biblioteca', alt: 'biblioteca', imagem: ImgBiblioteca }), _jsx(Card, { txt: 'Hist\u00F3rico de Empr\u00E9stimos', rota: '/home/emprestimos', alt: 'emprestimos', imagem: ImgEmprestimos })] }) }));
};
export default Main;
