...
import { CardsDiv, ContainerMain } from './Main.styles.js'
   ...
   return (
      <ContainerMain>
         <CardsDiv>
            ...
            <Card txt='Biblioteca' rota='/biblioteca' imagem={ImgBiblioteca} />
            <Card txt='Histórico de Empréstimos' rota='/emprestimos' imagem={ImgEmprestimos} />
         </CardsDiv>
      </ContainerMain>
   )
}
